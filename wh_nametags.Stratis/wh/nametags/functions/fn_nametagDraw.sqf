...
//	_cameraPositionAGL,_zoom] call wh_nt_fnc_nametagDraw;
//
...
then { 	linearConversion[WH_NT_DRAWDISTANCE_NEAR/1.3,WH_NT_DRAWDISTANCE_NEAR,
		(_distance / WH_NT_VAR_NIGHT),1,0,true] }
else { 	linearConversion[(((WH_NT_DRAWDISTANCE_CURSOR)*(_zoom))/1.3),
...
//	Adjust font sizes.
_sizeMain 		= WH_NT_FONT_SIZE_MAIN* _zmin;
_sizeSecondary 	= WH_NT_FONT_SIZE_SEC * _zmin;
_sizeVehicle 	= WH_NT_FONT_SIZE_VEH * _zmin;
