...
WH_NT_FONT_FACE_MAIN = (_fontData select 0);
WH_NT_FONT_FACE_SEC  = (_fontData select 1);
WH_NT_FONT_SHADOW	 = (_fontData select 4);
...
WH_NT_FONT_COLOR_GROUP	= (_colorData select 3);
WH_NT_FONT_COLOR_GROUPR = (_colorData select 4);
WH_NT_FONT_COLOR_GROUPG = (_colorData select 5);
WH_NT_FONT_COLOR_GROUPB = (_colorData select 6);
WH_NT_FONT_COLOR_GROUPY = (_colorData select 7);
...
_spacingMultiplier = WH_NT_FONT_SPREAD_MULTI * WH_NT_FONT_SIZE_SEC;
