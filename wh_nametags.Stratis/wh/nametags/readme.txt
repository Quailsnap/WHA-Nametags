...
- (C) Find a better way to change default font spacing between lines (ie: role on top,
	name in middle) depending on what font and font size is chosen.
- Find a better way to switch between cursorObject and cursorTarget depending on whether
	or not the player is currently in a vehicle.
- Find some way to optimize variable initialization and declaration in both Update and
	Draw: Just ten variables initializing into strings can add 0.4ms!! Namely: _vehicleName
	in draw
- Font spacing is determined purely vertically (3d nametags attached to varying points
	on the tgt, points that only differ by z-axis) and do not take into account, for
	instance, a player looking down at a 45deg angle at a friendly. Gotta find a way
	to take the angles into account and space the role / name / group tags out horizontally
 	as well as vertically.
- People at the corner of vision space out more. Okay?
- Driver (non-commander) tags are broken again.
