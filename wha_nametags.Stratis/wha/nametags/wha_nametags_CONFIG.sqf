...
WHA_NAMETAGS_NIGHT = true;				//	Whether night will affect tag visibility.	(true)

//	Information Shown
WHA_NAMETAGS_SHOW_GROUP 		= true;	//	Show group name under unit's name. 			(true)
WHA_NAMETAGS_SHOW_ROLE			= true; //	Show unit's role (rifleman, driver). 		(true)
WHA_NAMETAGS_SHOW_VEHICLEINFO 	= true;	//	Show vehicle info. Requires SHOW_ROLE.		(true)

//	Draw Distances
WHA_NAMETAGS_DRAWDISTANCE_CURSOR = 20; //	Distance to draw nametags when pointing at a unit.	(20)
								//	Should be greater than DISTANCE_ALL.
								//	Can be altered significantly depending on player FOV.
WHA_NAMETAGS_DRAWDISTANCE_NEAR = 10; 	//	Distance within which all nametags will be drawn.	(10)
...
//	Font Fade
WHA_NAMETAGS_FADETIME = 1;				//	Fade time for cursor tags after player mouses away.	(1)
...
WHA_NAMETAGS_FONT_SIZE_RAW = 0.036;		//	Default raw font size.						(0.036)
...
//	- STSand
//	- BromaPurple
WHA_NAMETAGS_FONT_COLOR = "WHGreen";		//	Font color set for nametag system.			("WHGreen")

//	Text Configuration: Position
WHA_NAMETAGS_FONT_HEIGHT_ONHEAD = false;	//	Attaches nametags to head (like ACE)		(false)
